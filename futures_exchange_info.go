...
func (c *Client) NewFuturesExchangeInfoService() *FuturesExchangeInfoService {
	return &FuturesExchangeInfoService{c: c}
}
...
// FuturesExchangeInfo exchange info
...
func (s *FuturesSymbol) LotSizeFilter() *LotSizeFilter {
...
func (s *FuturesSymbol) PriceFilter() *PriceFilter {
	for _, filter := range s.Filters {
...
func (s *FuturesSymbol) PercentPriceFilter() *PercentPriceFilter {
	for _, filter := range s.Filters {
...
func (s *FuturesSymbol) MarketLotSizeFilter() *MarketLotSizeFilter {
	for _, filter := range s.Filters {
...
func (s *FuturesSymbol) MaxNumOrdersFilter() *MaxNumOrdersFilter {
	for _, filter := range s.Filters {
...
func (s *FuturesSymbol) MaxNumAlgoOrdersFilter() *MaxNumAlgoOrdersFilter {
	for _, filter := range s.Filters {
...
func (s *FuturesSymbol) MinNotionalFilter() *MinNotionalFilter {
	for _, filter := range s.Filters {
